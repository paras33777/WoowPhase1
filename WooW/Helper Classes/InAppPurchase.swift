...
//  WooW
//
//  Created by Rahul Chopra on 29/06/21.
//
...
// IAP KEYS
struct IAPKeys {
    static let kMonthly = "com.monthly"
    static let kHalfYearly = "com.halfYearly"
    static let kYearly = "com.yearly"
    
    // Production
    static let kSecretKey = "a60e99e840bf43a89012c57998cd089e"
}
...
class RCInAppPurchase : NSObject {
    
    static let shared = RCInAppPurchase()
    ...
    func  withDidUpdatedTransactions ( _ callback : ((SKPaymentTransaction) -> Void)? = nil  ) ->  RCInAppPurchase{
    ...
    func  withDidReceiveProducts ( _ callback : (() -> Void)? = nil  ) ->  RCInAppPurchase{
    ...
    func  withClosureInvalidProductIdentifiers( _ callback : (([String]) -> Void)? = nil  ) ->  RCInAppPurchase{
    ...
    func withAppendProductId(_ value : String) -> RCInAppPurchase {
        productIDs.insert(value)
        
        return self
    }
    
    func actionRequestProductInfo()  -> RCInAppPurchase{
...
extension RCInAppPurchase : SKProductsRequestDelegate {
...
extension RCInAppPurchase : SKPaymentTransactionObserver {
...
extension SKProduct {
    var localizedPrice: String {
        if self.price != nil {
            ...
            self.priceLocale.currencySymbol
        } else {
            return "$0"
        }
    }
